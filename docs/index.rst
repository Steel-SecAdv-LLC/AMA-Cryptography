...
- **Native Performance**: C core for every primitive; optional Cython engine for the 3R math (no speed-up ratio is published)
...
- Cython mathematical engine for the 3R math (host-specific; no ratio is published)
