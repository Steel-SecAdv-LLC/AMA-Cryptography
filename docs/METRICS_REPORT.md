...
|--------------------------------------|---------:|-----------:|---------------------------------------------------------|
| Library (Python + C + headers)       | 80,444   | 21.4%      | `ama_cryptography/` + `src/c/` + `include/`             |
| Tests                                | 53,861   | 14.4%      | `tests/**/*.py`                                         |
| Top-level Python                     | 945      | 0.3%       | `*.py` at repo root                                     |
| Cython                               | 1,819    | 0.5%       | `*.pyx` + `*.pxd`                                       |
| Everything else (remainder)          | 238,136  | 63.5%      | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (generated `src/cython/*.c`, `tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total**              | **375,205** | **100%** | sum of the scopes above                                 |
