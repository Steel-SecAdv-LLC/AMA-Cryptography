...
| **Whole project** (source + docs + config) | 588 | **322,380** |
...
**Whole-project total** (`322,380` lines across Python, C, headers,
...
| Everything else (remainder) | 165,666 | 51.4% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **322,380** | **100%** | sum of the scopes above |
