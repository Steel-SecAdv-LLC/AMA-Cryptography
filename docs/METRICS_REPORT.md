...
| Scope | Count |
|-------|------:|
| Python test files under `tests/` matching the static regex | 152 |
| Syntactic `def test_` matches under `tests/**/*.py` | **3,602** |
...
The static count (3,602) and the dynamic collection count will differ.
