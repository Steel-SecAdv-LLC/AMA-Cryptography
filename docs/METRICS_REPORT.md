...
| **Whole project** (source + docs + config) | 691 | **393,161** |
...
**Whole-project total** (`393,161` lines across Python, C, headers,
...
| Everything else (remainder) | 202,386 | 51.5% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **393,161** | **100%** | sum of the scopes above |
