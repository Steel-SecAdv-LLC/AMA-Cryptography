...
| Tests (`tests/**/*.py`) | 163 | 66,336 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 588 | **321,977** |
...
**Whole-project total** (`321,977` lines across Python, C, headers,
...
| **Whole-project total** | **321,977** | **100%** | sum of the scopes above |
