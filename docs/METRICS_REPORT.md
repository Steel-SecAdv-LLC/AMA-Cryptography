...
| **Whole project** (source + docs + config) | 604 | **332,436** |
...
**Whole-project total** (`332,436` lines across Python, C, headers,
...
| Everything else (remainder) | 171,509 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **332,436** | **100%** | sum of the scopes above |
