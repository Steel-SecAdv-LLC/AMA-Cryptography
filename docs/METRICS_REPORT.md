...
| **Whole project** (source + docs + config) | 652 | **369,514** |
...
**Whole-project total** (`369,514` lines across Python, C, headers,
...
| Everything else (remainder) | 189,738 | 51.3% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **369,514** | **100%** | sum of the scopes above |
