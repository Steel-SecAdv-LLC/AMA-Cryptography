...
| **Whole project** (source + docs + config) | 615 | **338,457** |
...
**Whole-project total** (`338,457` lines across Python, C, headers,
...
| Everything else (remainder) | 175,364 | 51.8% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **338,457** | **100%** | sum of the scopes above |
