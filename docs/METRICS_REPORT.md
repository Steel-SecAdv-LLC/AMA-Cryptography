...
| Tests (`tests/**/*.py`) | 161 | 65,385 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 585 | **320,193** |
...
**Whole-project total** (`320,193` lines across Python, C, headers,
...
| **Whole-project total** | **320,193** | **100%** | sum of the scopes above |
