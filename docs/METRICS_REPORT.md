...
| **Whole project** (source + docs + config) | 735 | **416,057** |
...
**Whole-project total** (`416,057` lines across Python, C, headers,
...
| Everything else (remainder) | 216,013 | 51.9% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **416,057** | **100%** | sum of the scopes above |
