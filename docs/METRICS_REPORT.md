...
| **Whole project** (source + docs + config) | 595 | **326,933** |
...
**Whole-project total** (`326,933` lines across Python, C, headers,
...
| Everything else (remainder) | 168,544 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **326,933** | **100%** | sum of the scopes above |
