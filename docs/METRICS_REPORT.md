...
| **Whole project** (source + docs + config) | 728 | **410,556** |
...
**Whole-project total** (`410,556` lines across Python, C, headers,
...
| Everything else (remainder) | 211,215 | 51.4% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **410,556** | **100%** | sum of the scopes above |
