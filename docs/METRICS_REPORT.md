...
| Tests (`tests/**/*.py`) | 213 | 90,610 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 684 | **385,173** |
...
**Whole-project total** (`385,173` lines across Python, C, headers,
...
| **Whole-project total** | **385,173** | **100%** | sum of the scopes above |
