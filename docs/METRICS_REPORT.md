...
| Tests (`tests/**/*.py`) | 233 | 96,558 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 690 | **392,342** |
...
**Whole-project total** (`392,342` lines across Python, C, headers,
...
| **Whole-project total** | **392,342** | **100%** | sum of the scopes above |
