...
| **Whole project** (source + docs + config) | 727 | **410,241** |
...
**Whole-project total** (`410,241` lines across Python, C, headers,
...
| **Whole-project total** | **410,241** | **100%** | sum of the scopes above |
