...
| **Whole project** (source + docs + config) | 784 | **466,143** |
...
**Whole-project total** (`466,143` lines across Python, C, headers,
...
| Everything else (remainder) | 241,251 | 51.8% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **466,143** | **100%** | sum of the scopes above |
