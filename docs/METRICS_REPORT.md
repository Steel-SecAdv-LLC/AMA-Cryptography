...
| **Whole project** (source + docs + config) | 730 | **411,094** |
...
**Whole-project total** (`411,094` lines across Python, C, headers,
...
| Everything else (remainder) | 211,753 | 51.5% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **411,094** | **100%** | sum of the scopes above |
