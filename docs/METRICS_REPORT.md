...
| **Whole project** (source + docs + config) | 741 | **419,338** |
...
**Whole-project total** (`419,338` lines across Python, C, headers,
...
| Everything else (remainder) | 218,168 | 52.0% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **419,338** | **100%** | sum of the scopes above |
