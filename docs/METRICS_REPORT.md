...
| Tests (`tests/**/*.py`) | 218 | 94,071 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 674 | **383,897** |
...
**Whole-project total** (`383,897` lines across Python, C, headers,
...
| **Whole-project total** | **383,897** | **100%** | sum of the scopes above |
