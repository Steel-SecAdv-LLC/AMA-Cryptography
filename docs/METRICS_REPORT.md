...
| **Whole project** (source + docs + config) | 699 | **395,878** |
...
**Whole-project total** (`395,878` lines across Python, C, headers,
...
| Everything else (remainder) | 204,262 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **395,878** | **100%** | sum of the scopes above |
