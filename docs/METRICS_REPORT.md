...
| **Whole project** (source + docs + config) | 690 | **392,473** |
...
**Whole-project total** (`392,473` lines across Python, C, headers,
...
| Everything else (remainder) | 201,912 | 51.4% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **392,473** | **100%** | sum of the scopes above |
