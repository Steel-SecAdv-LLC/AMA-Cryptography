...
|--------------------------------------|---------:|-----------:|---------------------------------------------------------|
| Library (Python + C + headers) | 87,183 | 27.1% | `ama_cryptography/` + `src/c/` + `include/` |
...
| **Whole-project total** | **321,546** | **100%** | sum of the scopes above |
