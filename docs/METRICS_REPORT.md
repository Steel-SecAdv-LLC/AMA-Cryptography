...
| **Whole project** (source + docs + config) | 744 | **422,226** |
...
**Whole-project total** (`422,226` lines across Python, C, headers,
...
| Everything else (remainder) | 219,810 | 52.1% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **422,226** | **100%** | sum of the scopes above |
