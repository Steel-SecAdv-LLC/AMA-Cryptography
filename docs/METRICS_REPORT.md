...
| **Whole project** (source + docs + config) | 663 | **382,304** |
...
**Whole-project total** (`382,304` lines across Python, C, headers,
...
| **Whole-project total** | **382,304** | **100%** | sum of the scopes above |
