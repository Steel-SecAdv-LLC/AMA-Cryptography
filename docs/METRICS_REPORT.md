...
| **Whole project** (source + docs + config) | 604 | **332,529** |
...
**Whole-project total** (`332,529` lines across Python, C, headers,
...
| Everything else (remainder) | 171,602 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **332,529** | **100%** | sum of the scopes above |
