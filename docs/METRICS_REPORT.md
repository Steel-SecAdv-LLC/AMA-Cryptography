...
**Whole-project total** (`375,990` lines across Python, C, headers,
...
| Syntactic `def test_` matches under `tests/**/*.py` | **3,195** |
...
The static count (3,195) and the dynamic collection count will differ.
