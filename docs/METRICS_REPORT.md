...
| **Whole project** (source + docs + config) | 633 | **354,534** |
...
**Whole-project total** (`354,534` lines across Python, C, headers,
...
| Everything else (remainder) | 182,584 | 51.5% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **354,534** | **100%** | sum of the scopes above |
