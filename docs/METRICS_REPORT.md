...
|--------------------------------------|---------:|-----------:|---------------------------------------------------------|
| Library (Python + C + headers) | 88,641 | 26.9% | `ama_cryptography/` + `src/c/` + `include/` |
...
| **Whole-project total** | **329,023** | **100%** | sum of the scopes above |
