...
| **Whole project** (source + docs + config) | 694 | **385,647** |
...
**Whole-project total** (`385,647` lines across Python, C, headers,
...
| **Whole-project total** | **385,647** | **100%** | sum of the scopes above |
