...
| Scope | Count |
|-------|------:|
| Python test files under `tests/` matching the static regex | 142 |
| Syntactic `def test_` matches under `tests/**/*.py` | **3,414** |
...
The static count (3,414) and the dynamic collection count will differ.
