...
**Version:** 3.5.0
**Measurement Date:** 2026-07-30 (static LoC / test-function counts); benchmark figures last refreshed separately
...
| Scope | Count |
|-------|------:|
| Python test files under `tests/` matching the static regex | 127 |
| Syntactic `def test_` matches under `tests/**/*.py` | **3,057** |
...
The static count (3,057) and the dynamic collection count will differ.
