...
vendored NIST ACVP and Wycheproof JSON corpora (72,675 lines of `*.json` alone) and by this repository's Markdown, not by config.
...
| Syntactic `def test_` matches under `tests/**/*.py` | **6,560** |
