...
| **Whole project** (source + docs + config) | 604 | **333,039** |
...
**Whole-project total** (`333,039` lines across Python, C, headers,
...
| Everything else (remainder) | 172,112 | 51.7% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **333,039** | **100%** | sum of the scopes above |
