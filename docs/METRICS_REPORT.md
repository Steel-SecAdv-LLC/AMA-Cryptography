...
| **Whole project** (source + docs + config) | 588 | **322,416** |
...
**Whole-project total** (`322,416` lines across Python, C, headers,
...
| Everything else (remainder) | 165,702 | 51.4% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **322,416** | **100%** | sum of the scopes above |
