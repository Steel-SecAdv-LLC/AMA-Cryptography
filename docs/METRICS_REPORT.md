...
|--------------------------------------|---------:|-----------:|---------------------------------------------------------|
| Library (Python + C + headers) | 93,296 | 22.2% | `ama_cryptography/` + `src/c/` + `include/` |
...
| **Whole-project total** | **419,378** | **100%** | sum of the scopes above |
