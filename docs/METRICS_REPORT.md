...
| Tests (`tests/**/*.py`) | 260 | 108,553 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 754 | **430,686** |
...
**Whole-project total** (`430,686` lines across Python, C, headers,
...
| **Whole-project total** | **430,686** | **100%** | sum of the scopes above |
