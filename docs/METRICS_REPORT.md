...
| Tests (`tests/**/*.py`) | 161 | 65,265 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 585 | **320,073** |
...
**Whole-project total** (`320,073` lines across Python, C, headers,
...
| **Whole-project total** | **320,073** | **100%** | sum of the scopes above |
