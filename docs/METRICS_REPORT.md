...
| Tests (`tests/**/*.py`) | 271 | 122,315 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,898 |
| **Whole project** (source + docs + config) | 777 | **457,884** |
...
**Whole-project total** (`457,884` lines across Python, C, headers,
...
| **Whole-project total** | **457,884** | **100%** | sum of the scopes above |

Test code (26.7%) is roughly 1.3x the size of the library (20.9%) — i.e. the test-to-library ratio is roughly **1.28**, and that
...
| Syntactic `def test_` matches under `tests/**/*.py` | **6,403** |
