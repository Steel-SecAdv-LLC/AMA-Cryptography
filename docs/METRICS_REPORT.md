...
| Tests (`tests/**/*.py`) | 218 | 94,212 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 691 | **389,718** |
...
**Whole-project total** (`389,718` lines across Python, C, headers,
...
| **Whole-project total** | **389,718** | **100%** | sum of the scopes above |
