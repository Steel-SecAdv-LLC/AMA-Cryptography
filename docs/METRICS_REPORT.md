...
| Scope | Count |
|-------|------:|
| Python test files under `tests/` matching the static regex | 141 |
| Syntactic `def test_` matches under `tests/**/*.py` | **3,397** |
...
The static count (3,397) and the dynamic collection count will differ.
