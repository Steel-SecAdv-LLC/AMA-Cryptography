...
| **Whole project** (source + docs + config) | 635 | **355,694** |
...
**Whole-project total** (`355,694` lines across Python, C, headers,
...
| Everything else (remainder) | 183,050 | 51.5% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **355,694** | **100%** | sum of the scopes above |
