...
| **Whole project** (source + docs + config) | 754 | **430,702** |
...
**Whole-project total** (`430,702` lines across Python, C, headers,
...
| Everything else (remainder) | 224,817 | 52.2% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **430,702** | **100%** | sum of the scopes above |
