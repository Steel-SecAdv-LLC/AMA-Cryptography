...
| **Whole project** (source + docs + config) | 754 | **431,198** |
...
**Whole-project total** (`431,198` lines across Python, C, headers,
...
| Everything else (remainder) | 224,979 | 52.2% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **431,198** | **100%** | sum of the scopes above |
