...
| **Whole project** (source + docs + config) | 594 | **325,049** |
...
**Whole-project total** (`325,049` lines across Python, C, headers,
...
| Everything else (remainder) | 167,368 | 51.5% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **325,049** | **100%** | sum of the scopes above |
