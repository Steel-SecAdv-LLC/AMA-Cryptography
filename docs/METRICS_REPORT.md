...
| **Whole project** (source + docs + config) | 604 | **332,610** |
...
**Whole-project total** (`332,610` lines across Python, C, headers,
...
| Everything else (remainder) | 171,683 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **332,610** | **100%** | sum of the scopes above |
