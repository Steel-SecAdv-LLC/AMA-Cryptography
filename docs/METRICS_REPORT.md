...
| **Whole project** (source + docs + config) | 666 | **379,147** |
...
**Whole-project total** (`379,147` lines across Python, C, headers,
...
| Everything else (remainder) | 194,202 | 51.2% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **379,147** | **100%** | sum of the scopes above |
