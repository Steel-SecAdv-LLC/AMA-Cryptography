...
| **Whole project** (source + docs + config) | 595 | **327,200** |
...
**Whole-project total** (`327,200` lines across Python, C, headers,
...
| Everything else (remainder) | 168,742 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **327,200** | **100%** | sum of the scopes above |
