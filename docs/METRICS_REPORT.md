...
| **Whole project** (source + docs + config) | 649 | **367,545** |
...
**Whole-project total** (`367,545` lines across Python, C, headers,
...
| Everything else (remainder) | 188,868 | 51.4% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **367,545** | **100%** | sum of the scopes above |
