...
| **Whole project** (source + docs + config) | 753 | **427,518** |
...
**Whole-project total** (`427,518` lines across Python, C, headers,
...
| **Whole-project total** | **427,518** | **100%** | sum of the scopes above |
