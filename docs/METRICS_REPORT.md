...
| Tests (`tests/**/*.py`) | 260 | 108,071 |
| Cython (`*.pyx`, `*.pxd`) | 7 | 1,873 |
| **Whole project** (source + docs + config) | 756 | **429,195** |
...
**Whole-project total** (`429,195` lines across Python, C, headers,
...
| **Whole-project total** | **429,195** | **100%** | sum of the scopes above |
