...
|--------------------------------------|---------:|-----------:|---------------------------------------------------------|
| Library (Python + C + headers) | 88,817 | 26.9% | `ama_cryptography/` + `src/c/` + `include/` |
...
| **Whole-project total** | **329,964** | **100%** | sum of the scopes above |
