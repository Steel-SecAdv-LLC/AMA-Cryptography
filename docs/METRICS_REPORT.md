...
| Scope | Count |
|-------|------:|
| Python test files under `tests/` matching the static regex | 139 |
| Syntactic `def test_` matches under `tests/**/*.py` | **3,357** |
...
The static count (3,357) and the dynamic collection count will differ.
