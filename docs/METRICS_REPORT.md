...
| **Whole project** (source + docs + config) | 594 | **324,848** |
...
**Whole-project total** (`324,848` lines across Python, C, headers,
...
| Everything else (remainder) | 167,218 | 51.5% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **324,848** | **100%** | sum of the scopes above |
