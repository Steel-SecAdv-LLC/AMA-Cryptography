...
| **Whole project** (source + docs + config) | 635 | **355,652** |
...
**Whole-project total** (`355,652` lines across Python, C, headers,
...
| Everything else (remainder) | 183,008 | 51.5% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **355,652** | **100%** | sum of the scopes above |
