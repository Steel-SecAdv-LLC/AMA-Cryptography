...
| **Whole project** (source + docs + config) | 600 | **329,910** |
...
**Whole-project total** (`329,910` lines across Python, C, headers,
...
| **Whole-project total** | **329,910** | **100%** | sum of the scopes above |
