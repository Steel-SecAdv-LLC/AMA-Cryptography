...
|--------------------------------------|---------:|-----------:|---------------------------------------------------------|
| Library (Python + C + headers) | 88,557 | 26.9% | `ama_cryptography/` + `src/c/` + `include/` |
...
| **Whole-project total** | **328,939** | **100%** | sum of the scopes above |
