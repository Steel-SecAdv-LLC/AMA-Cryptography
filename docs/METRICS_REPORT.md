...
| **Whole project** (source + docs + config) | 694 | **385,634** |
...
**Whole-project total** (`385,634` lines across Python, C, headers,
...
| Everything else (remainder) | 198,969 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **385,634** | **100%** | sum of the scopes above |
