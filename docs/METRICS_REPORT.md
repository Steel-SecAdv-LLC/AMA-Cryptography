...
| **Whole project** (source + docs + config) | 781 | **463,355** |
...
**Whole-project total** (`463,355` lines across Python, C, headers,
...
| Everything else (remainder) | 239,093 | 51.6% | `*.md`, `*.yml`, `*.toml`, `*.json`, CMake, Makefile, plus `.c`/`.h`/`.py` outside the scopes above (`tests/c/`, `fuzz/`, `tools/`, `benchmarks/`, `examples/`) |
| **Whole-project total** | **463,355** | **100%** | sum of the scopes above |
