...
AMA Cryptography already has 16 libFuzzer fuzz targets running in CI. Onboarding to OSS-Fuzz provides:
...
4. **Submit a PR** to google/oss-fuzz with:
   ...
   - Description: Brief project description, link to repository, mention the 16 C fuzz targets
