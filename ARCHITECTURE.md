...
| C Unit Tests | Native library validation | All C functions | 77 `test_*.c` registered via ctest in `tests/c/` (+ 2 standalone `x25519_equiv_*.c`) |
...
**Total:** 5,166 Python test functions across 222 test files, plus the
