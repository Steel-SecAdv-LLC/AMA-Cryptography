...
| C Unit Tests | Native library validation | All C functions | 94 `test_*.c` registered via ctest in `tests/c/` (+ 2 `x25519_equiv_*.c` helper translation units linked into `test_x25519_field_equiv`) |
...
**Total:** 6,557 Python test functions across 270 test files, plus the
