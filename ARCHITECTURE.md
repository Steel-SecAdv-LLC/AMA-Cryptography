...
See [`INVARIANTS.md`](INVARIANTS.md) for the complete set (INVARIANT-1 through INVARIANT-46) and vendoring policy.
...
**Total:** 5,373 Python test functions across 238 test files, plus the
...
- `INVARIANTS.md`: Canonical architectural invariants (INVARIANT-1 through INVARIANT-46), including vendoring policy and CSRC_STANDARDS.md mapping (`.github/INVARIANTS.md` is a pointer to it)
