...
| C Unit Tests | Native library validation | All C functions | 79 `test_*.c` registered via ctest in `tests/c/` (+ 2 standalone `x25519_equiv_*.c`) |
...
**Total:** 5,264 Python test functions across 231 test files, plus the
