...
EXEMPT = {
    ...
    "docs/audit/PR394_CLAIMS.yaml": (
        "verbatim quotations of the documents under audit, including their own "
        "line citations, beside the command that reproduced each one; editing a "
        "quotation to satisfy this gate would falsify the evidence it records "
        "(same rationale as CHANGELOG.md, and the file is generated by "
        "docs/audit/run_claims.py rather than written by hand)"
    ),
}
