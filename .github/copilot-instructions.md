...
| File | Purpose |
|------|---------|
| `INVARIANTS.md` | Library invariants and vendoring policy |
| `.github/INVARIANTS.md` | Architectural invariants (INVARIANT-1 through INVARIANT-14) |
| `CONTRIBUTING.md` | Contribution guidelines |
| `CSRC_STANDARDS.md` | Algorithm-to-standard mapping |
| `.agents/AGENTS.md` | Comprehensive AI agent instructions |
