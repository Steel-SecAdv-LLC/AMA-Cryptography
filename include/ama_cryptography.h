...
#define AMA_CRYPTOGRAPHY_VERSION_STRING "3.0.0"
 ...
 * portable fallback). The selection is deterministic: changing the
 * compiler or target architecture is the only way to switch paths.
 *
