...
static void dispatch_init_internal(void) {
    ...
    /* Kyber NTT SIMD wiring: Phase 2 — all three incompatibilities fixed:
     *
     ...
     * 3. Pointwise multiply: SIMD now implements proper basemul with
     *    zetas[64+i] twiddle factors for degree-2 polynomial components.
     *
    ...
    /* Kyber NEON NTT: Phase 2 — all incompatibilities fixed (same as AVX2).
