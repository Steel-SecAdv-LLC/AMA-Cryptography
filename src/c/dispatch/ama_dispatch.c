...
typedef union {
    ...
    #define AMA_DISPATCH_SEAL_ATTR
#elif defined(__GNUC__) || defined(__clang__)
    #define AMA_DISPATCH_SEAL_ATTR __attribute__((aligned(AMA_DISPATCH_SEAL_PAGE)))
#elif defined(_MSC_VER)
    #define AMA_DISPATCH_SEAL_ATTR __declspec(align(AMA_DISPATCH_SEAL_PAGE))
#else
    #define AMA_DISPATCH_SEAL_ATTR
#endif

static ama_dispatch_sealed_storage_t dispatch_storage AMA_DISPATCH_SEAL_ATTR;
