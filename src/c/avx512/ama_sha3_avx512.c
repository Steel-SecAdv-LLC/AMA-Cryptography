...
/* ============================================================================
 * Single-state Keccak-f[1600] with AVX-512 acceleration
 *
 * Uses 512-bit ZMM registers for the theta column parity computation
 * (processing all 5 columns in one vector operation) and the chi step
 * (processing full rows with wider registers).
 * ============================================================================ */
